...
_G.packer_plugins = {
  ...
  fzf = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/fzf"
  },
  ["fzf.vim"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/fzf.vim"
  },
  ["galaxyline.nvim"] = {
    loaded = true,
  ...
  ["nvim-bufferline.lua"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/nvim-bufferline.lua"
  },
  ["nvim-compe"] = {
    loaded = true,
  ...
  ["nvim-whichkey-setup.lua"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/nvim-whichkey-setup.lua"
  },
  ["packer.nvim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/sam/.local/share/nvim/site/pack/packer/opt/packer.nvim"
  },
  vim = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/vim"
  },
  ["vim-which-key"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/vim-which-key"
  },
  vimwiki = {
    loaded = false,
    needs_bufread = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/opt/vimwiki"
  }
}
