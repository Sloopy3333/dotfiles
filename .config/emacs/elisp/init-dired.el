...
(use-package dired
  ...
  :hook (dired-mode . (lambda ()
                  ...
                  (evil-local-set-key 'normal (kbd "yy") 'dired-copy-file)
                  (evil-local-set-key 'normal (kbd "xx") 'sam/dired-cut)
                  (evil-local-set-key 'normal (kbd "cw") 'dired-do-rename) ;(lambda (x) (interactive "srename:") (rename-file (dired-get-filename) x) (revert-buffer)))
                  ...
                  (evil-local-set-key 'normal (kbd "cm") 'dired-do-chmod)
