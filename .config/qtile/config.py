    ...
    Screen(
        ...
        bottom=Bar(
            [
                ...
                #widget.ThermalSensor(threshold=70, tag_sensors="amdgpu", foreground_alert=my_colors["red"],foreground=my_colors["foreground"]),
                widget.ThermalSensor(tag_sensor="Tctl"),
                widget.TextBox(text="|",),
                widget.ThermalSensor(tag_sensor="edge", format="Gpu: {temp}{unit}"),
                widget.TextBox(text="|",),
